...
public class ViewEntryActivity extends AppCompatActivity {
    ...
    public void showAlertDialog(){
        ...
        builder.setMessage("Are you sure you want to delete your entry?");
        builder.setPositiveButton("And", (dialog, which) -> deleteEntry());
        builder.setNegativeButton("Interrupt", (dialog, which) -> {
        });
        builder.create().show();
    }
    /**
    ...
    private void deleteEntry() {
        ...
        Toast.makeText(ViewEntryActivity.this, "Your entry has been successfully deleted.", Toast.LENGTH_SHORT).show();
